...
angular.module("com.2fdevs.videogular.plugins.controls")
    ...
    ["$templateCache", function ($templateCache) {
        $templateCache.put("vg-templates/vg-play-pause-button",
            '<button class="iconButton" ng-click="onClickPlayPause()" aria-label="Play/Pause" type="button"></button>');
    }]
)
                ...
                scope.setState = function setState(newState) {
                    switch (newState) {
                        case VG_STATES.PLAY:
                            ...
                            elem.removeClass("ion-play");
                            elem.addClass("ion-pause");
                            break;

                        case VG_STATES.PAUSE:
                            scope.playPauseIcon = {play: true};
                            elem.removeClass("ion-pause");
                            elem.addClass("ion-play");
                            break;
...
angular.module("com.2fdevs.videogular.plugins.controls")
    ...
    ["$templateCache", function ($templateCache) {
        $templateCache.put("vg-templates/vg-mute-button",
            '<button type="button" class="iconButton ion-volume-medium" ng-class="muteIcon" ng-click="onClickMute()" ng-focus="onMuteButtonFocus()" ng-blur="onMuteButtonLoseFocus()" ng-keydown="onMuteButtonKeyDown($event)" aria-label="Mute"></button>');
    }]
)
